...
<div>
	...
	<section class="news-section">
		<div class="container">
			...
			<h2 class="big-title">Artículos Recientes</h2>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0ms">
					<div class="news-item">
						<div class="news_box">
							<div class="newsimg"><img class="img-responsive" src="https://images.unsplash.com/photo-1533293703114-a195e271b1bf?ixlib=rb-1.2.1&auto=format&fit=crop&w=751&q=80" alt=""></div>
							<div class="news-content">
								<div class="news_postdate">
								<span>Julio 20, 2019</span>
								</div>
								<a href="#">
							<h3>Master Class con Alex Alarcón</h3>
								</a>
								<p>Nuestro pianista ecuatoriano impartirá un MasterClass sobre interpretación popular. Dirigido a Músicos intrumentistas</p>
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0ms">
					<div class="news-item">
						<div class="news_box">
							<div class="newsimg"><img class="img-responsive" src="https://images.unsplash.com/photo-1528864158786-036d91e10510?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjM2MTcxfQ&auto=format&fit=crop&w=750&q=80" alt=""></div>
							<div class="news-content">
								<div class="news_postdate">
									<span>Julio 10, 2019</span>
								</div>
								<a href="#">
									<h3>Daniel Camacho, Pianista voluntario en Brasil</h3>
								</a>
								<p>Nuestro recién Graduado, Daniel Camacho comenzo una aventura como maestro pianista embajador de la Fundación "João Pinheiro" </p>
								<div class="news_authorinfo">
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="800ms">
					<div class="news-item">
						<div class="news_box">
							<div class="newsimg"><img class="img-responsive" src="https://images.unsplash.com/photo-1524175627468-e5a93581f37f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" alt=""></div>
							<div class="news-content">
								<div class="news_postdate">
									<span>Junio 27, 2019</span>
								</div>
								<a href="#">
									<h3>Festival "Hagamos Música"</h3>
								</a>
								<p>Celebrando el día de los músicos, nuestros alumnos participaron del festival "Hagamos Música" desarrollado en Guayaquil y Cuenca.</p>
								<div class="news_authorinfo">
